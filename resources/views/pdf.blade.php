  ...
  <table border="0" cellpadding="0" cellspacing="0" width="100%">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                  <tr>
                    <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                      ...
                      <p>{{$groom->fname.', '.$groom->lname}}<br>Furr Name: {{$groom->pet_name}}<br></p>
                    </td>
                  </tr>
                </table>
              </div>
            ...
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  ...
                  <td align="left" bgcolor="#D2C7BA" width="25%" style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><strong>{{$groom->gid}}</strong></td>
                </tr>
              ...
              @foreach($carts as $cart)
                  ...
                  <tr>
                  <td align="left" width="75%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">{{$cart->name}}</td>
                  <td align="left" width="25%" style="padding: 6px 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">{{$cart->price}}</td>
                  </tr>
               @endforeach
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                  <tr>
                    <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                      ...
                      <p>{{$groom->addressline}}<br>{{$groom->town}}<br>{{$groom->zipcode}}</p>
                    </td>
                  </tr>
                </table>
              </div>
    ...
    <tr>
      <td align="center" bgcolor="#D2C7BA" style="padding: 24px;">
        ...
        <![endif]-->
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <p style="margin: 0;"> <a href="" target="_blank">Go Back</a> </p>
          <!-- start permission -->
          <tr>
